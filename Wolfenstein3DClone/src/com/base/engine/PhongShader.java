...
public class PhongShader extends Shader{
	...
	public PhongShader(){
		super();
		addVertexShaderFromFile("phongVertex.vsh");
		addFragmentShaderFromFile("phongFragment.fsh");
		compileShader();
	...
	public static void setPointLights(PointLight[] pointLights){
		if(pointLights.length>MAX_POINT_LIGHTS){
			System.err.println("Error: MAX_POINT_LIGHTS="+MAX_POINT_LIGHTS+
					" Number supplied="+pointLights.length);
	...
	public static void setSpotLights(SpotLight[] spotLights){
		if(spotLights.length>MAX_SPOT_LIGHTS){
			System.err.println("Error: MAX_SPOT_LIGHTS="+MAX_SPOT_LIGHTS+
					" Number supplied="+spotLights.length);
			new Exception().printStackTrace();
			System.exit(1);
		}
